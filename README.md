...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-22 04:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d78a8416-6e97-490d-bf53-236b6cdb17a0.git
$ cd d78a8416-6e97-490d-bf53-236b6cdb17a0
```
